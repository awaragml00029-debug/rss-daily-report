...
> **今日焦点**：
癌症研究在多组学技术（WES、纳米孔、scRNA-seq）的驱动下，**首次**揭示了非小细胞肺癌术后复发的机制。

**主要方向**：
*   **肿瘤复发机制解析**：利用多组学技术深入理解癌症术后复发。
*   **肿瘤免疫与代谢**：线粒体脂质代谢在肿瘤免疫监视与逃逸中的作用。
*   **微生物与癌症治疗**：肠道细菌对癌症治疗药物疗效的影响。
*   **基因组编辑**：AI技术在基因组编辑领域的应用前景。

**技术亮点**：
*   **EDASeq包**：一键启动RNA-Seq分析，简化数据解读。
*   **Signac**：用于单细胞线粒体DNA分型与染色质可及性联合分析。
*   **多组学与机器学习**：识别三级淋巴结构，预测预后及免疫治疗疗效，AI驱动生信分析。

### 🧬 数据前沿

> **今日焦点**：
揭示了干细胞外泌体在糖尿病治疗中保护胰岛移植的潜力，以及利用先进技术解析大豆种子发育的复杂调控机制。

**主要方向**：
- 干细胞外泌体对胰岛移植的保护机制研究
- 大豆种子发育过程中营养积累的转录组与代谢组学解析
- 细胞死亡对视网膜神经节细胞成熟的影响

**技术亮点**：
- 结合空间转录组学与代谢组学，绘制发育过程的时空图谱
- FIRESCAPE技术用于生物分子清除、损伤诱导及细胞摄取的追踪
...
**6.** **10+生信，基于 Ro/e 发现不同治疗反应患者 CD8Teff 细胞比例差异。细胞丰度分析识别关键细胞目前在高分文章中很常见！**
- ✍️ **作者**：东晓生物
- 🏷️ **关键词**：生信
...
**8.** **轻松一读 | 15分1区纯生信，机器学习：这次我连代码都没写，就上了标题？**
- ✍️ **作者**：生信作曲家
- 🏷️ **关键词**：生信
...
**9.** **宁珖圣/Ping-Chih Ho团队TREIMM综述 | 线粒体脂质代谢在肿瘤免疫监视与免疫逃逸中的关键作用**
- ✍️ **作者**：CellPress全科学
- 🏷️ **关键词**：肿瘤
...
**10.** **河南农业大学陈震/姬祥团队Trends in Biotechnology综述 | AI点亮基因组编辑的未来图景**
- ✍️ **作者**：CellPress全科学
- 🏷️ **关键词**：基因组
...
**11.** **Cancer Cell｜警惕！你肠道内的这1种细菌，可能正“保护”癌细胞，让90%的抗癌药“失效”！**
- ✍️ **作者**：CNS文献精读会
- 🏷️ **关键词**：cancer
