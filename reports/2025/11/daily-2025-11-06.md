...
> **今日焦点**：
Nature 揭示流感和新冠病毒可激活休眠癌细胞，促进复发转移。Cell 报道 Perturb-seq (单细胞+CRISPR) 为机制研究提供新利器。

**主要方向**：
- 自身免疫性疾病中免疫细胞代谢调控机制。
- 食管鳞癌新辅助免疫联合化疗的疗效与安全性。
- AI驱动的空间细胞表型组学在非小细胞肺癌风险分层中的应用。

**技术亮点**：
- Cell Ranger 软件用于单细胞数据分析。
- LFK 不对称性指数检验和 Doi 图作为新型 Meta 分析偏倚检测工具。
- 空间转录组学高精度分析工具 cell_niches。

### 🧬 数据前沿

> **今日焦点**：
首次揭示牛肌内脂肪与皮下脂肪在脂肪祖细胞发育阶段和数量上的显著差异；多组学联合分析揭示了恶病质靶向组织在时空上协同响应癌症的机制。

**主要方向**：
*   **细胞发育与分化**：研究多能祖细胞的不同谱系命运、转录组及表面标记物，以及干细胞移植对脊髓损伤的功能恢复机制。
*   **疾病机制与调控**：解析病毒与化学暴露对人体免疫细胞的表观遗传动力学影响；揭示慢性应激对肝脏代谢及免疫的破坏，促进肝癌发生；研究PTEN蛋白缺陷前列腺肿瘤的基质重塑及衰老信号。
*   **生殖与发育**：探索小鼠卵母细胞和胚胎发育过程中的H2A.Z组蛋白掺入模式；生成由人诱导多能干细胞分化而来的腰段脊髓类器官。

**技术亮点**：
*   **多模态单细胞分析**：结合基因组结合/占用谱分析与高通量测序，深入解析细胞表观遗传动态。
*   **空间转录组学**：利用Xenium技术对人颈动脉斑块进行空间分辨率的单细胞转录组学研究。

### 🔬 期刊文章

> **今日焦点**：
首次揭示了TGS1作为ATM-TGS1-BRCA1轴的关键介质，是胰腺癌（PAAD）遗传毒性治疗耐药性的核心。

**主要方向**：
- 靶向ATM-TGS1-BRCA1轴，克服PAAD对遗传毒性疗法的耐药性。
- 探索TGS1在PAAD同源重组（HR）修复中的作用机制。

**技术亮点**：
- 鉴定TGS1为PAAD耐药性的新型关键因子。

### 🧪 博客更新

> **今日焦点**：
Answer ALS 发布首个包含超过2500名ALS患者RNA测序数据的综合数据集，并将其整合至Neuromine平台，为ALS研究提供多组学洞察。

**主要方向**：
- 探索ALS患者RNA测序和多组学数据，加速疗法开发。
- 推断剪接因子活性及其调控靶点，深入理解RNA加工和基因调控。
- 重建组织内细胞空间分布，揭示组织结构与基因表达的关系。

**技术亮点**：
- KATMAP：一种利用RNA测序数据推断剪接因子活性和调控靶点的新方法。
- Nicheformer：一种基于RNA测序和空间转录组学的新型基础模型，用于细胞组织重构。
