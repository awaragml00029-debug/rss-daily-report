...
> **今日焦点**：
艾伦脑科学研究所最新Nature，利用单细胞技术像“树叶”般精细分析脑科学数据；中科院曾安团队揭示幼年心脏再生关键细胞Clu⁺，为成人心脏再生提供新靶点。

**主要方向**：
*   **泛癌研究**：跨循环系统和组织，聚焦肿瘤神经浸润、代谢分析（含嘌呤代谢）、巨噬细胞极化与代谢交互作用。
*   **单细胞分析**：细胞类型注释自动化与整合（CellHint），基因模块识别（Hotspot），基因调控网络恢复（PRISM-GRN），跨组织多细胞协调。
*   **癌症研究**：推进癌症疫苗研发；中山大学团队揭示PRODH2在乳腺癌骨转移中的代谢-转录调控。

**技术亮点**：
*   **多组学整合**：泛癌+单细胞+空转+验证等多种组学分析方法。
*   **Meta分析工具**：metasens包用于处理二元结局Meta分析中的缺失数据。

### 🧬 数据前沿

> **今日焦点**：
单细胞RNA测序技术在解析炎症、癌症发生机制及细胞异质性方面取得新进展，尤其是在免疫细胞和肿瘤微环境研究中。

**主要方向**：
*   **肿瘤生物学**：探索药物（如青蒿素、大麻二酚）在肿瘤（胶质母细胞瘤、乳腺癌、前列腺癌）中的作用机制，以及关键蛋白（如EZH2、UGT2B17）对肿瘤进展的影响。
*   **免疫与炎症**：研究大麻二酚对炎症反应和T细胞分化的调控，以及巨噬细胞、中性粒细胞在疾病（肝纤维化、缺血性脑卒中）进展中的作用。
*   **神经科学与衰老**：解析缺血性脑卒中后神经损伤的调控机制，以及衰老相关组织（如白色脂肪组织）的转录组学变化。

**技术亮点**：
*   **单细胞RNA测序（scRNA-seq）**：广泛应用于解析复杂生物体系（如肿瘤、免疫细胞、脑组织）的细胞异质性和分子特征。
*   **转录组测序（RNA-seq）**：作为核心技术，用于揭示不同疾病模型和处理条件下的基因表达变化。

### 🧪 博客更新

> **今日焦点**：
QIAGEN 收购 Parse Biosciences，大幅拓展其单细胞解决方案，赋能 AI 药物发现。

**主要方向**：
- 单细胞 RNA 测序揭示藏猪优越的脂肪生成与寒冷适应机制。
- RNA 测序发现 Dnmt1 在软骨细胞能量代谢中调控骨骼生长的全新机制。

**技术亮点**：
- 突破性地实现高通量、无需仪器的单细胞 RNA 测序技术。
