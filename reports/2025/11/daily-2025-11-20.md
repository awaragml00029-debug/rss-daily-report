...
> **今日焦点**：
单细胞多组学技术突破，结合DNA甲基化和组蛋白修饰，首次动态重建表观基因组维持过程；中国科学家发明通用型抗癌免疫疗法，诱导特异性T细胞杀灭癌细胞。

**主要方向**：
*   **表观遗传学与疾病机制**：解析代谢异常与表观遗传调控多囊卵巢综合征（PCOS）的新机制，揭示PKM2介导组蛋白乳酸化在PCOS中的关键作用；研究全基因组倍增（WGD）在肿瘤进展中的演化动态。
*   **免疫与肿瘤治疗**：开发新型抗癌免疫疗法，使癌细胞表达外源性抗原诱导特异性T细胞杀灭；探索肿瘤突变如何引爆免疫治疗效果；研究肠道微生物组与自闭症的关联（缺乏科学证据）。
*   **单细胞技术与应用**：利用单细胞多组学（含空转、代谢组）发掘科研亮点；构建动态基因表达图谱数据库（Dynamic BodyMap）；绘制大规模T细胞图谱，为生物信息学注释提供“黄金标尺”。

**技术亮点**：
*   **单细胞多组学整合**：结合DNA甲基化、组蛋白修饰、RNA测序等，实现对表观基因组动态过程的精细解析。
*   **新型抗癌策略**：通过“嫁祸”策略，让癌细胞表达外源性抗原，实现精准免疫杀伤。

### 🧬 数据前沿

> **今日焦点**：
空间转录组学揭示了胶质母细胞瘤中具有抗肿瘤活性的蛋白激酶Cδ表达的微胶质细胞。

**主要方向**：
- 癌症免疫疗法：靶向SCUBE3、DPP4、CAR-T细胞、内源性逆转录病毒、FSTL3、KRAS信号通路、EZH2抑制剂、以及CDK抑制剂，以增强抗肿瘤免疫和治疗效果。
- 炎症与代谢性疾病：研究肥胖驱动的2型糖尿病，以及高血压对海马炎症和认知功能的影响。
- 免疫细胞调控：探索T细胞分化、NK细胞激活、以及口腔粘膜免疫的机制。

**技术亮点**：
- 空间转录组学：实现细胞分辨率下的基因表达和空间定位分析。
- Ribo-lite方法：首次实现低输入量下AML细胞的转录组和翻译组配对分析。

### 🔬 期刊文章

> **今日焦点**：
揭示了肿瘤起始阶段巨噬细胞极化驱动免疫抑制微环境的机制，并探索了双特异性抗体结合纳米技术在癌症免疫治疗中的协同增效潜力。

**主要方向**：
- 肿瘤微环境调控：研究EGFR驱动肺腺癌起始阶段，巨噬细胞如何通过BMP2/4-ACVR1信号极化，形成免疫抑制性微环境。
- 癌症免疫治疗策略：开发结合纳米技术与双特异性抗体（bsAb）的新型疗法，以提升疗效并降低毒性。
- 药物耐药机制解析：利用CRISPR-Cas9技术，识别胰腺癌中KRAS抑制剂的耐药机制。
- 肿瘤代谢与进展：研究线粒体转移如何挽救线粒体DNA缺陷癌细胞的呼吸功能，支持嘧啶合成并促进肿瘤生长。
- 信号通路靶向治疗：鉴定p300是IRF4的关键共激活剂，并将其作为靶点治疗多发性骨髓瘤。
- 肿瘤转移机制：阐明GRPR通路激活FAM135A，驱动前列腺癌的神经周浸润。

**技术亮点**：
- 单细胞RNA测序：用于表征肿瘤起始阶段免疫微环境的时间动态。
- CRISPR-Cas9基因编辑：用于系统性筛查KRAS抑制剂耐药机制。

### 🧪 博客更新

> **今日焦点**：
亚马逊蝎子毒液展现出对抗乳腺癌的强大潜力，其分子能有效杀灭癌细胞。

**主要方向**：
- 利用天然毒液成分（如亚马逊蝎子毒液）开发新型抗癌疗法。
- 结合放射性同位素、工程蛋白和人工智能，构建多维度癌症治疗工具。

**技术亮点**：
- 首次发现并利用亚马逊蝎子毒液中的特定分子，实现对乳腺癌细胞的高效杀灭。
- 创新性地将不同领域的先进技术（毒液、同位素、工程蛋白、AI）整合，以期实现更有效的癌症治疗。
